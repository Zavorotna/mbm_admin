...
<path d="M5.99745 5.44444H4.66909C3.44405 5.44444 2.42728 6.34544 2.33999 7.50834L1.50605 18.6195C1.40951 19.9058 2.48004 21 3.83515 21H15.1648C16.52 21 17.5905 19.9058 17.4939 18.6195L16.66 7.50834C16.5727 6.34544 15.556 5.44444 14.3309 5.44444H13.0025M5.99745 5.44444V3.22222C5.99745 1.99492 7.04288 1 8.33248 1H10.6675C11.9571 1 13.0025 1.99492 13.0025 3.22222V5.44444M5.99745 5.44444H13.0025" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <main class="privacy_container wrapper container">
      <h1>Політика конфіденційності</h1>
      <p class="head_info">Персональні дані Покупця збираються та обробляються відповідно до Закону України «Про захист персональних даних» від 01 червня 2010 № 2297-VI.</p>
      <div>
        <p>Покупець, проходячи процедуру реєстрації на Сайті та/або заповнюючи форму «оформити замовлення» на сайті Інтернет магазину «MBM» надає свою повну безумовну та безстрокову згоду на збирання, обробку та використання Продавцем інформації про Покупця, в тому числі інформації, що відповідно до чинного законодавства України вважається персональними даними, виключно в наступних цілях:</p>
      </div>
      <ul class="mark">
        ...
        <li>з метою сумлінного виконання Продавцем своїх договірних зобов’язань перед Покупцем, в тому числі зобов’язань щодо доставки Товару, а також зобов’язань щодо перерахування Покупцю коштів за повернутий Товар;</li>
      ...
      <div> 
        <p>Надана Покупцем інформація використовується при обробці Замовлення, а також для надання Покупцю комерційних пропозицій Продавця.</p>
      ...
      <div> 
        <p>Продавець не несе відповідальності за відомості, надані Покупцем на Сайті в загальнодоступній формі.</p>
        <p>Продавець має право здійснювати записи телефонних розмов з Покупцем, про що Продавець повідомляє Покупця. При цьому Продавець зобов’язується: запобігати спробам несанкціонованого доступу до інформації, отриманої в ході телефонних переговорів, і / або передачу її третім особам, які не мають безпосереднього відношення до виконання Замовлень, відповідно до Закону України «Про інформацію» від 02.10.1992 року № 2657-XII.</p>
        <p>Будь-яка інформація, отримана від Покупця, є конфіденційною, та не розкривається третім особам, за винятком випадків, передбачених чинним законодавством України.</p>
      </div>
      <div> 
        <p>При оплаті замовлень на сайті Інтернет-магазину «MBM», за допомогою платіжних карт всі операції з ними здійснюються на захищеній платіжній сторінці банку, на якій потрібно ввести дані платіжної картки. Після успішної транзакції (успішної оплати замовлення платіжною карткою на платіжній сторінці банку) відвідувач сайту автоматично переадресовується на сторінку замовлення «MBM», де вказано номер сформованого замовлення.</p>
      </div>
    </main>
