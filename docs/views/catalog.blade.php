...
<html lang="en">
  <head>
    ...
    <meta name="title" content="Каталог одягу для всієї родини — МВМ">
    <meta name="description" content="Каталог одягу від українського бренду МВМ. Одяг для жінок, чоловіків, дівчаток та хлопчиків. Великий асортимент стильного та комфортного одягу.">
    <meta name="keywords" content="каталог одягу, жіночий одяг, чоловічий одяг, дитячий одяг, одяг для дівчаток, одяг для хлопчиків, стильний та комфортний одяг, каталог одягу від MBM">
    ...
    <title>Каталог магазину МВМ — Стильний і комфортний одяг для усієї родини</title>
  </head>
  <body> 
...
<path d="M5.99745 5.44444H4.66909C3.44405 5.44444 2.42728 6.34544 2.33999 7.50834L1.50605 18.6195C1.40951 19.9058 2.48004 21 3.83515 21H15.1648C16.52 21 17.5905 19.9058 17.4939 18.6195L16.66 7.50834C16.5727 6.34544 15.556 5.44444 14.3309 5.44444H13.0025M5.99745 5.44444V3.22222C5.99745 1.99492 7.04288 1 8.33248 1H10.6675C11.9571 1 13.0025 1.99492 13.0025 3.22222V5.44444M5.99745 5.44444H13.0025" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <main> 
      <section class="catalog wrapper container" id="catalog">
        <h1>каталог</h1>
        <form class="grid wrapper category_btn" action="#">
          <label>
            <input class="catalog_cta items-center" type="radio" name="categoryBtn"><span>для жінок</span>
          </label>
          <label>
            <input class="catalog_cta items-center" type="radio" name="categoryBtn"><span>для чоловіків</span>
          </label>
          <label>
            <input class="catalog_cta items-center" type="radio" name="categoryBtn"><span>для дівчаток</span>
          </label>
          <label>
            <input class="catalog_cta items-center" type="radio" name="categoryBtn"><span>для хлопчиків</span>
          </label>
        </form>
        <div class="filter flex-between">
          <div class="filter_container"> 
            <div class="info-item"><a class="readmore flex items-center" href="#"><span>фільтр</span><span class="svg_btn">
                   <svg xmlns="http://www.w3.org/2000/svg" width="25rem" height="15rem" viewBox="0 0 12 7" fill="none">
<path d="M1 1L6 6L11 1" stroke="#121212" stroke-linecap="round"/>
</svg></span></a>
              <div class="description-more">
                <form action="#">
                  <p class="header-filter">Ціна</p>
                  <div class="slider-range">
                    <div class="range" id="range"></div>
                    <div class="values"><span id="min-value" data-value="50"></span><span id="max-value" data-value="200"> </span></div>
                  ...
                  <div class="flex-between"> 
                    <div class="category_filter"> 
                      ...
                      <label class="flex items-center">
                        <input type="checkbox" name="category" value="">Костюми
                      </label>
                      <label class="flex items-center"> 
                        <input type="checkbox" name="category" value="">Штани
                      </label>
                      <label class="flex items-center"> 
                        <input type="checkbox" name="category" value="">Худі
                      </label>
                      <label class="flex items-center"> 
                        <input type="checkbox" name="category" value="">Світшоти
                      </label>
                      <label class="flex items-center"> 
                        <input type="checkbox" name="category" value="">Футболки
                      </label>
                    </div>
                    <div class="color_filter"> 
                      <p>Колір</p>
                      <label class="flex items-center">
                        <input type="checkbox" name="color" value="">Чорний
                      </label>
                      <label class="flex items-center"> 
                        <input type="checkbox" name="color" value="">Бежевий
                      </label>
                      <label class="flex items-center"> 
                        <input type="checkbox" name="color" value="">Марсала
                      </label>
                      <label class="flex items-center"> 
                        <input type="checkbox" name="color" value="">Білий
                      </label>
                      <label class="flex items-center"> 
                        <input type="checkbox" name="color" value="">Блакитний
                      </label>
                    </div>
          ...
          <div class="sort-select flex">
            <p>сортувати:</p>
            <label class="arrow-select">
              <div class="select">
                <input class="select__input" type="hidden">
                <div class="select__in">за популярністю</div>
                <div class="select__list">
                  <div class="select__item" data-value="2">ціна за спаданням</div>
                  <div class="select__item" data-value="3">ціна за зростанням</div>
                  <div class="select__item" data-value="5">за популярністю</div>
                </div>
              </div>
            </label>
          </div>
