...
<path d="M5.99745 5.44444H4.66909C3.44405 5.44444 2.42728 6.34544 2.33999 7.50834L1.50605 18.6195C1.40951 19.9058 2.48004 21 3.83515 21H15.1648C16.52 21 17.5905 19.9058 17.4939 18.6195L16.66 7.50834C16.5727 6.34544 15.556 5.44444 14.3309 5.44444H13.0025M5.99745 5.44444V3.22222C5.99745 1.99492 7.04288 1 8.33248 1H10.6675C11.9571 1 13.0025 1.99492 13.0025 3.22222V5.44444M5.99745 5.44444H13.0025" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <main class="wrapper container order_container">
      ...
      <form action="#">
        ...
        <div class="grid">
          <div class="name">
            ...
            <input id="name" type="text" name="userName" minlength="3" maxlength="30" placeholder="Імʼя*" required oninput="this.value = this.value.replace(/[^a-zA-Zа-яА-ЯїЇєЄіІґҐs]/g, '')">
          </div>
          <div class="surname">
            <label for="surname"> Прізвище*</label>
            <input id="surname" type="text" name="userSurname" minlength="3" maxlength="30" placeholder="Прізвище*" required oninput="this.value = this.value.replace(/[^a-zA-Zа-яА-ЯїЇєЄіІґҐs]/g, '')">
          </div>
        </div>
        <div class="grid">
          <div class="nameParent">
            <label for="nameParent">По-батькові*</label>
            <input id="nameParent" type="text" name="userParentName" minlength="3" maxlength="30" placeholder="По-батькові*" required oninput="this.value = this.value.replace(/[^a-zA-Zа-яА-ЯїЇєЄіІґҐs]/g, '')">
          </div>
          <div class="phone">
            <label for="phone">Телефон*</label>
            <input class="phoneInput inputMask" type="tel" name="userPhone" placeholder="+380 " required maxlength="13"><span class="error-tel"></span>
          </div>
        </div>
        <div class="grid"> 
          <div class="delivery_method"> 
            <h2>Оберіть спосіб доставки:</h2>
            <div class="flex post_icon">
              <label>
                <input class="up" type="radio" name="post">
              </label>
              <label>
                <input class="np" type="radio" name="post">
              </label>
            </div>
          ...
          <div class="pay_method"> 
            ...
            <label class="items-center">
              <input type="radio" name="pay" required><span>Оплата на рахунок</span>
            </label>
            <label class="items-center">
              <input type="radio" name="pay" required><span>Готівкою при отриманні</span>
            </label>
            <label class="items-center">
              <input type="radio" name="pay" required><span>Накладений платіж</span>
            </label>
          </div>
        </div>
        <div class="flex basket_cta order_cta"><a class="cta catalog_cta" href="basket.html">назад у кошик</a>
          <button class="cta black_cta" type="submit">підтвердити</button>
        </div>
      </form>
    </main>
