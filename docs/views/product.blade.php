...
<html lang="en">
  <head>
    ...
    <meta name="title" content="&lt;назва моделі&gt; + &lt;бренд (MBM)&gt;">
    <meta name="description" content="Купити &lt;назва моделі&gt; від українського бренду МВМ. Стильний та комфортний одяг для &lt;категорія (жінок/чоловіків/дівчаток/хлопчиків)&gt;.">
    <meta name="keywords" content="одяг від українського бренду МВМ, &lt;назва моделі&gt;, &lt;категорія (одяг для жінок/одяг для чоловіків/одяг для хлопчиків/одяг для дівчаток)&gt;">
...
<path d="M5.99745 5.44444H4.66909C3.44405 5.44444 2.42728 6.34544 2.33999 7.50834L1.50605 18.6195C1.40951 19.9058 2.48004 21 3.83515 21H15.1648C16.52 21 17.5905 19.9058 17.4939 18.6195L16.66 7.50834C16.5727 6.34544 15.556 5.44444 14.3309 5.44444H13.0025M5.99745 5.44444V3.22222C5.99745 1.99492 7.04288 1 8.33248 1H10.6675C11.9571 1 13.0025 1.99492 13.0025 3.22222V5.44444M5.99745 5.44444H13.0025" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <main class="wrapper">
      <div class="product_container container">
        <div class="grid col-2 card-main">
          <div class="img-block"> 
            <div class="small-img"><a class="btn btn-next" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="20" viewBox="0 0 170 20" fill="none">
<path d="M81 12L85 8L89 12" stroke="#1E1E1E" stroke-linecap="round"/>
</svg></a>
              <div class="carousel-card products-sm">
                <div class="small-img-parent carousel-item">
                  <picture> <img class="small-image" src="img/card1.jpg" alt=""></picture>
                </div>
                <div class="small-img-parent carousel-item">
                  <picture> <img class="small-image" src="img/card2.jpg" alt=""></picture>
                </div>
              </div><a class="btn btn-prev" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="20" viewBox="0 0 170 20" fill="none">
<path d="M89 8L85 12L81 8" stroke="#1E1E1E" stroke-linecap="round"/>
</svg></a>
            </div>
            <div class="main-img general-img" itemscope itemtype="http://schema.org/Product">
              <picture> <img class="main-card-img" itemprop="image" src="img/card1.jpg" alt=""></picture>
            </div>
          </div>
          <div class="description_container" itemscope itemtype="http://schema.org/Product">
            <h1 itemprop="name">однотонний чоловічий базовий світшот</h1>
            <div class="flex items-center product_btn_change"><a class="toggle-btn active_product" href="#" data-target="rozdrib">роздріб</a><a class="toggle-btn" href="#" data-target="gurt">гурт</a></div>
            <div class="description_product_one" id="rozdrib">
              <div class="price_block" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                <p class="price" itemprop="price">1050 ₴</p>
              </div>
              <div class="info-item"><a class="readmore flex-between items-center" href="#"><span>Опис товару</span><span class="svg_btn">
                     <svg xmlns="http://www.w3.org/2000/svg" width="10" height="5" viewBox="0 0 12 7" fill="none">
<path d="M1 1L6 6L11 1" stroke="#fff" stroke-linecap="round"/>
</svg></span></a>
                <div class="description-more">
                  <ul class="mark" itemscope itemtype="http://schema.org/Product">
                    <li itemprop="description">Тканина: якісна 95% турецька бавовна;</li>
                    <li itemprop="description">Тип крою - звичайний;</li>
                    <li itemprop="description">Круглий виріз;</li>
                    <li itemprop="description">Манжети на резинці;</li>
                  </ul>
                </div>
              </div>
              <div class="info-item"><a class="readmore flex-between items-center" href="#"><span>Розмірна сітка</span><span class="svg_btn">
                     <svg xmlns="http://www.w3.org/2000/svg" width="10" height="5" viewBox="0 0 12 7" fill="none">
<path d="M1 1L6 6L11 1" stroke="#fff" stroke-linecap="round"/>
</svg></span></a>
                <div class="description-more">
                  <table> 
                    <thead> 
                      <tr> 
                        <th>розмір</th>
                        <th>довжина рукава від шиї</th>
                        <th>довжина виробу від шиї</th>
                        <th>напівобхват виробу</th>
                      </tr>
                    </thead>
                    <tbody> 
                      <tr>
              ...
              <form action=""> 
                ...
                <div class="size_container"> 
                  <p>оберіть розмір:</p>
                  <div class="flex items-center category_btn card_size_btn">
                    <label>
                      <input class="catalog_cta items-center" type="radio" name="size"><span>xs</span>
                    </label>
                    <label>
                      <input class="catalog_cta items-center" type="radio" name="size"><span>s</span>
                    </label>
                    <label>
                      <input class="catalog_cta items-center" type="radio" name="size"><span>m</span>
                    </label>
                    <label>
                      <input class="catalog_cta items-center" type="radio" name="size"><span>l</span>
                    </label>
                  </div>
                </div>
                <button class="submit-btn spivpracia_submit_btn" type="submit">додати в кошик</button>
              </form>
            </div>
            <div class="description_product_opt none_product" id="gurt">
              <div class="flex items-center price_block" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                <p class="price" itemprop="price">575 ₴</p>
                <p class="price_rozdrib" itemprop="price">575 ₴</p>
              </div>
              <div class="info-item"><a class="readmore flex-between items-center" href="#"><span>Опис товару</span><span class="svg_btn">
                     <svg xmlns="http://www.w3.org/2000/svg" width="10" height="5" viewBox="0 0 12 7" fill="none">
<path d="M1 1L6 6L11 1" stroke="#fff" stroke-linecap="round"/>
...
<path d="M1 1L6 6L11 1" stroke="#fff" stroke-linecap="round"/>
              ...
              <form action="#">
                ...
                <div class="size_container"> 
                  <p>ростовка:</p>
                  <div class="category_btn card_size_btn opt_size">
                    <label>
                      <input class="btn_opt catalog_cta items-center" type="checkbox" name=""><span>від розміру XS до XL</span>
                    </label>
                  </div>
                </div>
                <div class="flex items-center order-product">
                  <button class="submit-btn spivpracia_submit_btn" type="submit">додати в кошик</button><a class="spivpracia_btn spivpracia_product_btn" href="#">співпраця</a>
                </div>
              </form>
            </div>
          </div>
      ...
      <section class="same_product container"> 
        <h2>схожі товари</h2>
...
<path d="M4.14821 4.11111H3.21837C2.36083 4.11111 1.64909 4.74181 1.588 5.55584L1.00424 13.3336C0.936654 14.2341 1.68602 15 2.63461 15H10.5654C11.514 15 12.2633 14.2341 12.1958 13.3336L11.612 5.55584C11.5509 4.74181 10.8392 4.11111 9.98163 4.11111H9.05178M4.14821 4.11111V2.55556C4.14821 1.69645 4.88002 1 5.78274 1H7.41726C8.31998 1 9.05178 1.69645 9.05178 2.55556V4.11111M4.14821 4.11111H9.05178" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="flex cta_main"><a class="submit-btn spivpracia_submit_btn" href="catalog.html">усі товари</a></div>
      </section>
    </main>
