...
<html lang="en">
  <head>
    ...
    <meta name="title" content="Кошик покупок — МВМ">
    <meta name="description" content="Товари, які додано до кошика. Покупка одягу українського бренду MBM.">
    <meta name="keywords" content="кошик покупок, онлайн замовлення, МВМ">
    ...
    <title>Кошик магазину МВМ — Стильний і комфортний одяг для усієї родини</title>
  </head>
  <body> 
...
<path d="M5.99745 5.44444H4.66909C3.44405 5.44444 2.42728 6.34544 2.33999 7.50834L1.50605 18.6195C1.40951 19.9058 2.48004 21 3.83515 21H15.1648C16.52 21 17.5905 19.9058 17.4939 18.6195L16.66 7.50834C16.5727 6.34544 15.556 5.44444 14.3309 5.44444H13.0025M5.99745 5.44444V3.22222C5.99745 1.99492 7.04288 1 8.33248 1H10.6675C11.9571 1 13.0025 1.99492 13.0025 3.22222V5.44444M5.99745 5.44444H13.0025" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <main class="wrapper container basket_container">
      <div class="flex-between">
        <h1>кошик</h1><a class="delete_cart" href="#">очистити кошик </a>
      </div>
      <hr>
      <div class="basket-card grid items-center">
        <picture> <img src="img/card1.jpg" alt=""></picture>
        <div class="grid descr_grid items-center">
          <div class="description_bascket"> 
            <h2>однотонний чоловічий базовий світшот</h2>
            <p>розмір: <span>S </span></p>
            <form class="flex items-center quantity_container" action="#">
...
<path d="M9.896 13.0208H15.1043" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div class="flex basket_cta"><a class="cta catalog_cta" href="catalog.html">продовжити покупки</a><a class="cta black_cta" href="order.html">оформити замовлення</a></div>
    </main>
